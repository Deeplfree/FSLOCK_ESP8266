...
//x1,y1：终点坐标
//BMP[]：要写入的图片数组
void OLED_ShowPicture(u8 x0, u8 y0, u8 x1, u8 y1, u8 p[])
{
	// u8 x, y;
	// for (y = y0; y < y1; y++)
	// {
...
{
	OLED_ShowPicture(0, 2, 127, 8, bilibili);
}
void OLED_ShowBilibili2()
{
	OLED_ShowPicture(0, 2, 127, 8, bilibili2);
}
void OLED_Showok1()
{
	OLED_ShowPicture(79, 2, 127, 8, ok1);
}
void OLED_Showno1()
{
	OLED_ShowPicture(79, 2, 127, 8, no1);
}
void OLED_Showxiaodianshi1()
{
	OLED_ShowPicture(38, 2, 89, 8, xiaodianshi1);
}
void OLED_Showblack()
{
	OLED_ShowPicture(0,2,127,8,black);
}
